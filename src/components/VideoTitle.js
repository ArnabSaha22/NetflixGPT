...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video pt-[30%] px-10 absolute text-white bg-gradient-to-r from-black">
...
//w-screen aspect-video pt-96 px-6 absolute text-white z-10 bg-gradient-to-t from-black
